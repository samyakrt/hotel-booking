...
const Modal: React.FC<React.PropsWithChildren<Props>> = ({ isOpen, onClose, children, size = 'md' }) => (
            ...
            >
              <Dialog.Panel
                className={classNames(
                  sizes[size],
                  'relative bg-white rounded-lg px-4 pt-5 pb-4 text-left shadow-xl transform transition-all sm:my-8 w-full sm:p-6',
                )}
              >
                <div className="hidden sm:block absolute top-0 right-0 pt-6 pr-6">
                  ...
                  >
                    <XIcon className="h-3 w-3 text-blue-500" />
                  </PlainButton> */}
                </div>
                <div>
                  {children}
